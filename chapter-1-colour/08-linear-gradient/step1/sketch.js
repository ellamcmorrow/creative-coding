...
var colorCount = 20; //number of colors
...
function draw() {
  ...
  for (var i = 0; i < colorCount; i++) { //increment the index
    if (i % 2 == 0) { // if the increment is an even number
      ...
      saturationValues[i] = random(90, 100);
      brightnessValues[i] = 50;
    }
  }
...
//determine the x value based on where the last part or fragment was drawn
      ...
      var h = rowHeight;
  // the left over modulus will be a different color -- creating a offset
